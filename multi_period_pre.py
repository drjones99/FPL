...
def solve_multi_period_pre_season_fpl(horizon, objective='regular', decay_base=0.84, no_transfer=False):
    ...
    #players_no_gk = model.add_variables(players, gameweeks, name='players_no_gk', vartype=so.binary)    
    ...
    ## Bench constraints
    model.add_constraints((bench[p,w,0] == 0 for p in players for w in gameweeks), name='bench_0_for_gk')
